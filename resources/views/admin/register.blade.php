...
<div class="card">
    ...
    <div class="card-body p-lg-17">
        ...
        <div class="position-relative mb-17">
            <u><h3> <b> Candidate Register Form </b> </h3></u>
        </div>
        <!--end::-->
        <!--begin::Layout-->
                ...
                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="candidate_form" enctype="multipart/form-data">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="mobileno" name="mobileno" id="mobileno" autocomplete="off" maxlength="11" onkeypress="return /[0-9]/i.test(event.key)">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            ...
                            <input type="file" class="form-control form-control-solid" placeholder="resume" name="resume" id="resume">
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                    </div>
